...
'Nhập số lượng khách\r\n'
WebUI.setText(findTestObject('Đặt tour/txt_soLuongKhach'), '-')
...
WebUI.verifyElementAttributeValue(findTestObject('Đặt tour/txt_soLuongKhach'), 'validationMessage', 'Vui lòng nhập một số.', 
    0)
