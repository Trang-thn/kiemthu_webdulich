...
WebUI.setText(findTestObject('Themtour_btl/Page_Admin Dashboard/input_mota'), mota)
...
WebUI.verifyElementPresent(findTestObject('Themtour_btl/Page_Admin Dashboard/tit_dăngtour'), 0)
